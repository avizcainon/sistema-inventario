...
<head>
    ...
    <title>{{ config('app.name', 'North Store') }}</title>
...
<body>
    <div id="app">
            ...
            @if (Auth::user()!=null)
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('facturas.index') }}">Facturas</a>
                        </li>
                        @if (Auth::user()!=null)
                             @if (Auth::user()->id_user_type == 1)
                             <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('register') }}">Registrar usuario</a>
                                </li>
        ...
        <main class="py-4 --bs-dark-bg-subtle">
            @yield('content')
        </main>
    </div>
</body>
